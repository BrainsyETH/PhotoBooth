...
class PhotoPrinter @Inject constructor() {
    ...
    fun print(context: Context, bitmap: Bitmap, jobName: String = "SnapCabin Print") {
    ...
    fun printPhotoSize(context: Context, bitmap: Bitmap, size: PhotoPrintSize) {
        ...
        val adapter = PhotoPrintAdapter(bitmap, "SnapCabin - ${size.label}")
        printManager.print("SnapCabin Print", adapter, PrintAttributes.Builder()
